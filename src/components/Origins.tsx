...
const BODY_TEXT =
  'Deep Science Ventures is a venture creator that pairs founder-type scientists with deep domain expertise to build high-impact companies across climate, computation, agriculture and pharma — reasoning backwards from the outcome the world needs. To date it has launched 58 companies, attracted $240M in funding and built a portfolio valued at $700M. But these founders are extremely rare because they are often PhD degree holders, and the PhD often trains you out of deep-tech entrepreneurship. In 2023, DSV launched a 3-year PhD in invention — the Venture Science Doctorate is a fully-funded programme that trains Venture Scientists to design their own research from first principles and launch breakthrough deep-tech ventures, with 14 Venture Scientists currently in training. Alpha turns that same doctrine into an agentic workflow anyone can run.'
